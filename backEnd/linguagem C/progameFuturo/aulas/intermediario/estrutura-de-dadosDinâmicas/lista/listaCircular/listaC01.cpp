...
/*
	...
	Lista Circular:
		->	O último nó o ponteiro proximo aponta para o primeiro nó
		-> 	Sabemos que chegamos no final quando o ultimo nó aponta para o inicio
	...
	Estrutura:
		...
		1Nó->proximo -> 2Nó *ultimo nó* (
			valor: 78
			próximo: -> aponta para o próximo 1Nó
		)
